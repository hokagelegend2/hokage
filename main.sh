...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m           WELCOME TO SCRIPT HOKAGE LEGEND              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://github.com/hokagelegend2/hokage/main/"
start=$(date +%s)
secs_to_human() {
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/hokagelegend1"},{"text":"Contack","url":"https://wa.me/087726917005"}]]}'
...
wget https://raw.githubusercontent.com/hokagelegend2/hokage/refs/heads/main/Cfg/m-noobz 
