...
TIMES="10"
CHATID="6369685620"
KEY="7099310060:AAFLsT7bVpYQISe4u5uev209q0ZS-tXw1xs"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/izin | grep $ipsaya | awk '{print $3}')
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>────────────────────</code>
<b> 🟢 SUKSES REGIST AUTOSCRIPT 🟢</b>
<code>────────────────────</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/bumiayuvpn"},{"text":"Contack","url":"https://wa.me/6285217318115"}]]}'
...
wget https://raw.githubusercontent.com/BmyVpn/bumiayuvpn/main/Cfg/m-noobz 
